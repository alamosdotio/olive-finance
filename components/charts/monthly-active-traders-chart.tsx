    ...
    datasets: [
        {
            ...
            data: [8.5, 86.87, 25.2, 45.8, 52.3, 78.9, 32.1, 28.7, 15.8],
    ...
    return (
        <div className="w-full h-full flex flex-col bg-inherit">
            <div className="flex-none">
                <h2 className="text-xl font-semibold text-white mb-2">Monthly Active Traders</h2>
            </div>
...
export default MonthlyActiveTraders;