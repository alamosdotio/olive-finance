...
const Fallback = () => {
    ...
    return(
        <div className="w-full m-auto p-6 flex h-[188px] justify-center items-center">
            ...
            {/* <ProtectedRoute fallback={<Fallback />}> */}
                <section className="px-6 py-3 space-y-[10px]">
                    {currentItems.map((pos, idx) => (
                        <OpenFutures key={idx} token={pos.token} logo={pos.logo} symbol={pos.symbol} type={pos.futureType} position={pos.position}/>
                    ))}
                </section>
