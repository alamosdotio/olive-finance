    ...
    <div
      className={
        value === "" || parseFloat(value) <= 0
          ? "hidden"
          : "w-full border rounded-sm flex flex-col"
      }
    >
      <div
      ...
      >
        <span className="text-sm font-medium text-secondary-foreground h-6 items-center flex">
          Order Summary
        </span>
        <div className="flex space-x-3 items-center">
          <Button className="bg-secondary p-2 w-fit h-auto rounded-sm">
            <RotateCw className="text-secondary-foreground" />
          </Button>
          {dropDownActive ? (
            <ChevronUp className="text-secondary-foreground text-sm w-4 h-4" />
          ) : (
            <ChevronDown className="text-secondary-foreground text-sm w-4 h-4" />
          )}
        </div>
      </div>
      {dropDownActive && (
            ...
            <div className="w-full flex flex-col space-y-1">
              <div className="w-full flex justify-between">
                ...
                <span className="text-secondary-foreground text-sm font-medium">
                  {formatPrice(minRec)} {contractType}
                </span>
              </div>
              <div className="w-full flex justify-between">
                <div className="flex space-x-[6px] items-center">
